...
/*
* Database class, handles creation and migrations between versions
*/
@Database(entities = [RideEntity::class, SegmentEntity::class, LogEntity::class, VersionEntity::class], version = 13,exportSchema = false)
